...
class CreateNumerologyMapControllerTest
    ...
    constructor(
        ...
        fun `test createNumerologyMap success`() {
            ...
            `when`(
                sendMessageGptAdapter.createNumerologyMap(userResponse, correlationId),
            ).thenReturn(ThreadResponseDto("thread_gdTBaeDCwRrjAOBI0C5vNCsQ", 1704608683L, "queued"))
            ...
            assertEquals(
                responseBody,
                "{\"thread_id\":\"thread_gdTBaeDCwRrjAOBI0C5vNCsQ\",\"created_at\":1704608683,\"status\":\"queued\"}",
            )
        }
